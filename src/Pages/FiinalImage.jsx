...
function FiinalImage({ product, uniquekey }) {
	...
	const SaveDataApi = (item, index) => {
		...
		formData.append("LogIpAddress", "180.151.78.50");
		formData.append("CompanyId", "SUSHL");
		formData.append("BrandCode", "UC");
		formData.append("CountryCode", "IN");
		formData.append("LogUserId", "ANKIT");
						...
						.map((item, index) => (
							<>
								<div
									...
									{console.log(item, index, "index image")}
									{!input1 &&
